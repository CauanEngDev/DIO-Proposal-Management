package com.cauandev.proposalmanagement.auth.infrastructure.security;
...
import com.cauandev.proposalmanagement.auth.infrastructure.persistence.repository.UserRepository;
    ...
    CommandLineRunner initDatabase(UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            if (userRepository.count() == 0) {
                ...
                userRepository.saveAll(List.of(fitnessInfluencer, techInfluencer, brand));
            }
        };
    }
}
