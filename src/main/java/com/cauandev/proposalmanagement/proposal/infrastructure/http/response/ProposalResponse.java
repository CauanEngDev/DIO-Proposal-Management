package com.cauandev.proposalmanagement.proposal.infrastructure.http.response;
...
public record ProposalResponse(String id, String title, String description, OwnerResponse ownerResponse) {
