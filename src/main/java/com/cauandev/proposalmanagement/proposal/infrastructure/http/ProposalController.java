package com.cauandev.proposalmanagement.proposal.infrastructure.http;

import com.cauandev.proposalmanagement.auth.domain.UserRole;
import com.cauandev.proposalmanagement.auth.infrastructure.persistence.entity.User;
import com.cauandev.proposalmanagement.proposal.application.CreateProposalUseCase;
import com.cauandev.proposalmanagement.proposal.application.ListProposalUseCase;
...
import com.cauandev.proposalmanagement.proposal.infrastructure.http.request.CreateProposalRequest;
import com.cauandev.proposalmanagement.proposal.infrastructure.http.response.ProposalResponse;
...
public class ProposalController {
    ...
    @GetMapping
    @PreAuthorize(("hasRole('INFLUENCER', 'BRAND')"))
